...
const subCategories = ["All", "Live Dance Show", "Wrestling"];
...
export default function Events() {
  ...
  const filteredPhotos = activeFilter === "All" 
    ? categories.events 
    : categories.events.filter(p => p.subCategory === activeFilter);
  ...
  return (
    <Layout>
      <div className="pt-32 pb-16 px-6 md:px-12 max-w-screen-2xl mx-auto">
        ...
        >
          <h1 className="font-serif text-5xl md:text-6xl text-foreground mb-6">Events</h1>
          <p className="text-muted-foreground font-light text-lg">
            Action, endurance, and grace. From the visceral intensity of the mud akhadas to the fluid beauty of classical dance.
          </p>
        </motion.div>
